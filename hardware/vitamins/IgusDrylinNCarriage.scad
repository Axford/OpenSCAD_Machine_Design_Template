...
// Face connector is on upper surface, at the edge
function IgusDrylinNCarriage_Con_Face(t)		 = [ [0,IgusDrylinNCarriage_HH(t) - IgusDrylinNCarriage_H(t)/2,0], [0,-1,0], 0, 0, 0];
